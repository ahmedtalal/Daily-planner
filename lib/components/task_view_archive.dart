...
import 'package:daily_planner/pages/task_operations/task_Details_archive.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

// ignore: must_be_immutable
class TaskViewArchive extends StatelessWidget {
  var taskModel;
  TaskViewArchive({
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => TaskDetailsArchive(data: taskModel),
          ),
        );
      },
      child: Card(
